...
%TODO: subsection appprofondita su LSMI 
...
%TODO: aggiustare tabelle (girare e sistemare)
\clearpage
\thispagestyle{empty}
\begin{landscape}
\vspace*{\fill}
\begin{center}
\input{tables/algorithms.tex}\label{tab:algorithms}
\input{tables/datasets.tex}\label{tab:datasets}
\end{center}
\vspace*{\fill}
\end{landscape}

%TODO: Assenza di dataset video spatially varing
