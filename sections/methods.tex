...
\begin{tikzpicture}[
    node distance=0.8cm,
    block/.style={rectangle, draw, fill=blue!20, text width=7cm, text centered, rounded corners, minimum height=1.2cm, font=\normalsize},
    process/.style={rectangle, draw, fill=green!20, text width=7cm, text centered, rounded corners, minimum height=1.2cm, font=\normalsize},
    subblock/.style={rectangle, draw, fill=green!10, text width=7cm, text centered, rounded corners, minimum height=0.9cm, font=\small},
    optional/.style={dashed, draw=gray!70, thick},
    output/.style={rectangle, draw, fill=orange!20, text width=7cm, text centered, rounded corners, minimum height=1.4cm, font=\normalsize},
    arrow/.style={->, >=stealth, thick},
    optarrow/.style={->, >=stealth, thick, dashed, gray!70}
]
...
% Sub-blocks for spatial methods - positioned to the side
\node[subblock, right=1.5cm of spatial, text width=4cm, align=left] (methods) {
    \textbf{Metodi Base:}\\
    \footnotesize
    • GW, WP\\
    • SoG, GE\\[0.1cm]
...
% Intermediate output
\node[process, below=1.2cm of spatial] (stack) {Stack di Mappe $\{\hat{\mathbf{E}}_t\}_{t=1}^T$};
...
% Normalization
\node[process, below=of temporal] (norm) {\textbf{Normalizzazione L2}\\$\mathbf{E}_t(x,y) = \dfrac{\tilde{\mathbf{E}}_t(x,y)}{\|\tilde{\mathbf{E}}_t(x,y)\|_2}$};
...
\draw[optarrow] (stack.east) -- ++(1.8,0) |- (norm.east) node[pos=0.85, right, font=\scriptsize, text=gray] {bypass};
